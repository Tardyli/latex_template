...
{\tnr\fontsize{12pt}{20pt}\selectfont\hbadness=10000
\begin{sloppypar}
...
{\tnr\fontsize{12pt}{20pt}\selectfont\hbadness=10000
\begin{sloppypar}
\noindent{\bfseries Key words: }MRI Medical Image; StyleGAN2; 3D Gaussian Splatting; Medical Image Generation; Teaching Platform
\end{sloppypar}}
