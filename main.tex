...
\IfFontExistsTF{FangSong_GB2312}{%
    ...
    \IfFileExists{fonts/simfang.ttf}{%
        ...
        \IfFontExistsTF{FangSong}{%
            ...
            \PackageError{cuit-thesis}{Required font FangSong_GB2312, simfang.ttf or FangSong not found}{Upload fonts/simfang.ttf to the Overleaf project, or compile on a system with FangSong_GB2312/FangSong installed.}
        }
    }
}
...
\DeclareCaptionLabelFormat{thesiscaptionlabel}{#1#2}
\captionsetup{
...
\renewcommand{\tagform@}[1]{%
    \maketag@@@{{\tnr\fontsize{10.5pt}{20pt}\selectfont （#1）}}%
}
\makeatother
...
\cftsetindents{section}{2em}{3.2em}
\cftsetindents{subsection}{4em}{4.2em}
...
\newcommand{\customtableofcontents}{
    ...
    \vspace{0pt}
    {\thesistocfont\noindent\hfill 论文总页数：{\tnr\pageref{LastPage}}页\par}
...
\renewcommand*{\bibfont}{\songti\fontsize{12pt}{20pt}\selectfont}
