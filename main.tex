...
\IfFileExists{fonts/simfang.ttf}{%
    ...
    \IfFontExistsTF{FangSong}{%
        ...
        \PackageError{cuit-thesis}{Required font FangSong not found}{Upload fonts/simfang.ttf to the Overleaf project, or compile on a system with FangSong installed.}
    }
}
